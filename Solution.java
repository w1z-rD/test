...
/**
 * ƒано исходное и конечное слово равной длины. ƒлина исходных слов не ограничена. Ќеобходимо составить цепочку слов от исходного слова до конечного.
 *  аждое следующее слово в цепочке может отличатьс€ от предыдущего только одной буквой. »сходное, конечное и все промежуточные слова должны состо€ть из одинакового количества букв.
 * ¬се используемые слова об€зательно должны содержатьс€ в заранее определенном словаре. ÷епочка слов должна быть наименьшей длины из всех возможных.
 *Ќа вход в программу подаетс€:
 *1.	ѕуть к текстовому файлу, в котором указано начальное и конечное слово. Ќа первой строке указано начальное слово, на второй строке конечное.
 *2.	ѕуть к файлу, который содержит словарь. —лова в словаре указаны по одному на каждой строке. ¬ словаре слова могут быть разной длины.
 *Ќа выходе программа должна вывести в консоль путь от исходного слова к конечному, по одному слову на одной строке.
 */
